...
select msk.tir_num_tiers_tir,
  ...
  from mouvement_stock msk, flat_structure fls
 where msk.nmv_code_nature_mouvement_nmv = '030'
   and msk.msk_date_mouvement
   between to_date('&&startday.', 'yyyy-mm-dd hh24:mi:ss') and -- Change here
